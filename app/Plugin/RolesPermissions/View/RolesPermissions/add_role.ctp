<?php    echo $this->Html->script('RolesPermissions.roles');
         echo $this->Html->css('RolesPermissions.rolespermissions');
?>    
   
   <div class="row">        
      <?php echo $this->Form->create('AdminRole', array('url' => array('controller' => 'RolesPermissions', 'action' => 'addRole'),'id'=>'adminRoleId'));              
         ...
         <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('role_name',array('label' => false,'div' => false, 'placeholder' => 'Role Name','class' => 'form-control','maxlength' => 30));?>
               </div>
            </div>
         </div>
         <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('role_description',array('type'=>'textarea','label' => false,'div' => false, 'placeholder' => 'Role Description','class' => 'form-control','maxlength'=>150));?>
               </div>
            </div>
         </div>  
         <div class="col-lg-12">
