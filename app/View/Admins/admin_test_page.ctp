...
//echo $this->Html->script('admin/admin_reports'); ?>
    <script>
      ...
      function showform(methodobj){ 
         var methodVal = $(methodobj).val();
         $('#mainToggleDiv').show();
         if(methodVal == 1){
            $('#recurringDiv').hide();
         }else{
            $('#recurringDiv').show();
              ...
              $(function() {
               if($('OrderPaymentMethod').val() != ""){
                  showform($('#OrderPaymentMethod'));
               }
...
$( ".datepicker" ).datepicker();
   ...
   <div class="row">        
      <?php echo $this->Form->create('Order', array('url' => array('controller' => 'admins', 'action' => 'test_page'),'id'=>'testPageID'));              
      ...
      <div class="col-lg-5">
         <div class="col-lg-12"><h3>Payment Gateway</h3></div>
         <div class="col-lg-12">
            <div class="form-group form-spacing">
               <div class="col-lg-4 form-label">
                  <label>Payment Via<span class="required"> * </span></label>
               </div>
               <div class="col-lg-8 form-box">                
                 <?php $methods = array (0=>"Paypal",1 =>"Braintree"); ?>
                   <?php echo $this->Form->select('Order.payment_method',$methods,array('div'=>false,'label'=>false,'empty'=>'Select','class' => 'form-control','onchange'=>'showform(this)')); ?>
               </div>
            </div>
         </div>
         <div id= "mainToggleDiv" style="display:none;">
          ...
          <div class="col-lg-12">
           ...
           <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('Order.billing_name',array('label' => false,'div' => false, 'placeholder' => 'UserName','class' => 'form-control','maxlength' => 50));?>
               </div>
            </div>
         </div>
        <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('Order.billing_street_1',array('label' => false,'div' => false, 'placeholder' => 'Street 1','class' => 'form-control','maxlength' => 100));?>
               </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('Order.billing_street_2',array('label' => false,'div' => false, 'placeholder' => 'Street 2','class' => 'form-control','maxlength' => 100));?>
               </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
               <div class="form-group form-spacing">
                  ...
                  <div class="col-lg-8 form-box">                
                      <?php echo $this->Form->input('Order.billing_state',array('label' => false,'div' => false, 'placeholder' => 'State','class' => 'form-control','maxlength' => 30));?>
                  </div>
               </div>
            </div>
        <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('Order.billing_city',array('label' => false,'div' => false, 'placeholder' => 'City','class' => 'form-control','maxlength' => 30));?>
               </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                    <?php echo $this->Form->input('Order.billing_zip',array('label' => false,'div' => false, 'placeholder' => 'Zip','class' => 'form-control','maxlength' => 6));?>
               </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                   <?php echo $this->Form->input('Order.billing_phone',array('label' => false,'div' => false, 'placeholder' => 'Phone','class' => 'form-control','maxlength' => 12));?>
               </div>
            </div>
        </div>
         <div class="col-lg-12">
        ...
        <div class="col-lg-12" id= "recurringDiv">
            <div class="form-group form-spacing">
               <div class="col-lg-4 form-label">
        ...
        <!--<div class="col-lg-12">
            <div class="form-group form-spacing">
               <div class="col-lg-4 form-label">
                  <label>Brain Tree<span class="required"> * </span></label>
               </div>
               <div class="col-lg-8 form-box" style="padding-top: 7px;">                
                   <?php //echo $this->Form->input('payment_method',array('label' => false,'div' => false,'type '=> 'checkbox','value'=>1));?>
               </div>
            </div>
        </div>-->
                     ...
                     <div class="form-group form-spacing">
                        ...
                        <div class="col-lg-8 form-box" >                
                            <?php if(isset($this->request->data['Order']['payment_date']) && $this->request->data['Order']['payment_date'] !="") { $date  = date('m-d-Y',strtotime($this->request->data['Order']['payment_date'])); }else{ $date= ""; }?>           
                             <?php echo $this->Form->input('Order.payment_date',array('type'=>'text','label' => false,'div' => false, 'value'=>$date,'placeholder' => 'Payment Date','class' => 'form-control datepicker','maxlength' => 55,'readonly'=>true));?>
                        </div>
                     </div>
                 </div>
