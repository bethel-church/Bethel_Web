                ...
                <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody class="dyntable">
                        ...
                        foreach($getData as $key => $getData)
                        {
                            ...
                            ?>
                        <tr <?php echo $class;?>>
                            <td align="center"><input type="checkbox" name="checkboxes[]" class ="checkboxlist" value="<?php echo base64_encode($getData['Country']['id']);?>" ></td>     
                           <?php   $status = $getData['Country']['status'];
                            ...
                            <td align="center"><?php echo $this->Html->link($this->Html->image("Countries.".$statusImg.".png", array("alt" => ucfirst($statusImg),"title" => ucfirst($statusImg))),'javascript:void(0)',array('escape'=>false,'id'=>'link_status_'.$getData['Country']['id'],'onclick'=>'setStatus('.$pid.')')) ; ?></td>
