...
<div class="bigHeading leftAlign fullWidth">
   ...
   <div>
      <?php echo $this->Form->create(null, array('url' => array('controller' => 'trips', 'action' => 'addedit'),'type'=>'file','id'=>'userId'));              
               ...
               <div class="form-group form-spacing">
                 ...
                 <div class="rightAlign" style="width:45%">
                  ...
                  ?>
                      <label class="cusSelect">Main Trip Leader</label> 
                      <br />
                      <div >Please upload your .csv file before selecting this trip's leader</div>
           ...
           <div class="col-lg-12 form-spacing">
               <div class="form-group form-spacing">
                  ...
                  <div class="center" >
                     ...
                     <?php 
                     if($this->request->data['Trip']['csv_file'] != ""){
                      $str = "<span class=\"st\">Current File:</span> ".$this->request->data['Trip']['csv_file'];
                     }else{
                      $str = "";
                     }
                     ?>
                     <div id="fileContainer" class="fileContainer"><?php echo $str;?></div>
