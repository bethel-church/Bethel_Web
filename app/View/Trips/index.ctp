<?php    
   ...
   <div class="mainH noborder leftAlign" style="height:36px;border:1px solid #ccc;border-radius:4px;">
       ...
       if($selected_trip_type ==1){
        $active_class = "inactiveFHeading";
        $archived_class = "activeFHeading";
       }else{
        $active_class = "activeFHeading";
        $archived_class = "inactiveFHeading";
       }
	   if($b == "1"){
	    $second_class = "activeHeading";
		$mission_class = "inactiveHeading";
	   }else{
		$second_class = "inactiveHeading";
		$mission_class = "activeHeading";
	
	   }		

       ?>
      <div id="activeD" style="margin:5px 0px 5px 5px;"  class="leftAlign">
      <a style="line-height:23px;" href="/trips/index/a:<?php echo $a;?>/b:0" class="<?php echo $mission_class;?>">Mission Trips</a>
      </div>
      <div style="margin:5px 5px 5px 0px;" class="rightAlign">
      <a style="line-height:23px;margin-left:0px" href="/trips/index/a:<?php echo $a;?>/b:1" class="<?php echo $second_class;?>">2nd Year Travel</a>
      </div>


	<!--<div id="activeD" style="width:50%;margin:5px;"  class="leftAlign">
      <a style="line-height:23px;" href="/trips/index/a:<?php e//cho $a;?>/b:0" class="<?php //echo $mission_class;?>">Mission Trips</a>
      </div>
      <div style="width:50%;margin:5px" class="rightAlign">
      <a style="line-height:23px;margin-left:5px" href="/trips/index/a:<?php //echo $a;?>/b:1" class="<?php //echo $second_class;?>">2nd Year Travel</a>
      </div>-->
   ...
   <div style="clear:both"></div>
    ...
    <div class="row">
        <div class="col-lg-4" style="width:100%;margin-bottom:5px">                        
             <a href="/trips/index/a:0/b:<?php echo $b;?>" class="<?php echo $active_class;?>">ACTIVE TRIPS (<?php echo $active_trips['active'];?>)</a>
             <a style="margin-left:5px" href="/trips/index/a:1/b:<?php echo $b;?>" class="<?php echo $archived_class;?>">ARCHIVED TRIPS (<?php echo $active_trips['archived'];?>)</a>
        </div>            
    </div>
