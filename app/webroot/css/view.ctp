  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <tr><td><input type="checkbox" name="receiptType[]" class="cb-element" <?php echo $t6;?> value="Supplies"> Supplies</td><td><input type="checkbox" name="receiptType[]" class="cb-element" <?php echo $t7;?> value="Fun Day ($25 Max)"> Fun Day ($25 Max) </td></tr>
        ...
        <div id="dRange">Show receipts from <span id="stDate" >Jan1, 2016 </span> until <span id="enDate">Dec 31, 2016</span></div>
        <input type="hidden" name="startDate" id="datetimepicker1" />
        <input type="hidden" name="endDate" id="datetimepicker2" />
        </p>
      </div>
      <div class="modal-footer">
